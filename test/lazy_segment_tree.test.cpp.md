...
data:
  ...
  bundledCode: "#line 1 \"test/lazy_segment_tree.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/range_affine_range_sum\"\
    ...
    \ 7 \"container/lazy_segment_tree.cpp\"\n#include <vector>\n#include <cassert>\n\
    ...
    \ Monoid { e.a * m.sum + e.b * Fp::raw(m.size), m.size };\n}\n\nint main() {\n\
    ...
    \ (Q--) {\n        usize t;\n        std::cin >> t;\n        if (t == 0) {\n \
    \           usize l, r;\n            std::cin >> l >> r;\n            u32 b, c;\n\
    \            std::cin >> b >> c;\n            seg.operate(l, r, Effector { Fp::raw(b),\
    \ Fp::raw(c) });\n        }\n        else {\n            usize l, r;\n       \
