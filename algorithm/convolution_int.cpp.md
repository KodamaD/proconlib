...
data:
  ...
  bundledCode: "#line 2 \"algorithm/convolution_int.cpp\"\n#include <algorithm>\n\
    ...
    \ 10 \"algorithm/convolution_int.cpp\"\n\ntemplate <class T, std::enable_if_t<std::is_integral_v<T>>*\
    \ = nullptr>\nstd::vector<T> convolution_int(const std::vector<T>& a, const std::vector<T>&\
    \ b) {\n    const usize n = a.size(), m = b.size();\n    if (n == 0 || m == 0)\
    \ return {};\n    static constexpr u64 MOD1 = 754974721, MOD2 = 167772161, MOD3\
    \ = 469762049;\n    static constexpr u64 M2M3 = MOD2 * MOD3, M1M3 = MOD1 * MOD3,\
    \ M1M2 = MOD1 * MOD2;\n    static constexpr u64 M1M2M3 = MOD1 * MOD2 * MOD3;\n\
    \    static constexpr u64 I1 = mod_inv(MOD2 * MOD3, MOD1);\n    static constexpr\
    \ u64 I2 = mod_inv(MOD1 * MOD3, MOD2);\n    static constexpr u64 I3 = mod_inv(MOD1\
    \ * MOD2, MOD3);\n    static constexpr u64 OFFSET[5] = {0, 0, M1M2M3, 2 * M1M2M3,\
