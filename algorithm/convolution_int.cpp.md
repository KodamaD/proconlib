...
data:
  ...
  bundledCode: "#line 2 \"algorithm/convolution_int.cpp\"\n#include <algorithm>\n\
    ...
    \ 7 \"math/mod_pow.cpp\"\n\ntemplate <class T> constexpr u32 mod_pow(T x, u64\
    \ exp, const u32 mod) {\n    assert(mod > 0);\n    if (mod == 1) return 0;\n \
    ...
    \     }\n                len += 2;\n            }\n        }\n    }\n\n    void\
    \ butterfly_inv(std::vector<M>& a) const {\n        const usize n = a.size();\n\
    ...
    \    static constexpr u64 M2M3 = MOD2 * MOD3, M1M3 = MOD1 * MOD3, M1M2 = MOD1\
    \ * MOD2;\n    static constexpr u64 M1M2M3 = MOD1 * MOD2 * MOD3;\n    static constexpr\
    \ u64 I1 = mod_inv(MOD2 * MOD3, MOD1);\n    static constexpr u64 I2 = mod_inv(MOD1\
